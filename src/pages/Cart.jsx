        ...
        {cartItems.map((item) => (
            <tr key={item.id}>
                <td className="product-thumbnail">
                    <img src={`images/product-${item.product.id}.png`}
                    ...
                    style={{ maxWidth: '120px' }}>
                        <div className="input-group-prepend">
                            <button className="btn btn-outline-black decrease" type="button"
                                onClick={() => updateQuantity(item.id, item.quantity - 1)}>&minus;</button>
                        </div>
                        <input type="text" className="form-control text-center quantity-amount"
                ...
                <td><a href="#" className="btn btn-black btn-sm" onClick={() => 
                    removeItem(item.id)}>X</a></td>
            </tr>
        ))}
                </tbody>
            </table>
            ...
            <div className="col-md-7">
                ...
                <div className="row mb-5">
                    ...
                    <div className="col-md-6 text-right">
                        <strong className="text-black">R{total.toFixed(2)-(0,15)}</strong>
                    </div>
                </div>
                ...
                <div className="row mb-5">
                    ...
                    <div className="col-md-6 text-right">
                        <strong className="text-black">R{total.toFixed(2)}</strong>
                    </div>
                </div>
